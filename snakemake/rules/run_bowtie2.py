...
rule bowtie2_pe:
    ...
    input:
        read1="{assayID}/{runID}/{assayID}/{runID}/{outdir}/trimmed_data/{unit}_R1_001.fastq.gz",
        read2="{assayID}/{runID}/{assayID}/{runID}/{outdir}/trimmed_data/{unit}_R2_001.fastq.gz",
        bt2_index=config["references"]["CanFam3.1"]["genome"]
    output:
